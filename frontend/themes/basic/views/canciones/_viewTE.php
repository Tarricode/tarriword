...
<div class="ui tree blue raised segment">

  <div class="ui items">
    <div class="item">
      <div class="content">

        <a class="header"><?= $model->Titulo?></a>
        ...
        <div class="extra"><i class="green check icon"></i> <?= backend\models\Likes::find()->where(["Id_Caciones"=>$model->Id])->count();?> Likes </div>
      </div>
    </div>
  </div>
