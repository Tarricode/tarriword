		...
		<div class="panel-body">
			...
			<div class="ui four statistics">
				...
				<div class="statistic">
					...
					<div class="label">Mis Canciones</div>
				</div>
				<!-- Total de usuarios Registrados -->
				<div class="statistic">
					<div class="value" data-tooltip="" data-position="bottom center"><i class="checked calendar icon"></i>
						<?= User::find()->count(); ?>
					</div>
					<div class="label">Por Terminar</div>
				</div>
				<!-- Total de usuarios Inactivos -->
				<div class="statistic">
					<div class="value" data-tooltip="" data-position="bottom center"><i class="world icon"></i>
						<?= Canciones::find()->where(["Permiso"=>"1"])->count(); ?>
					</div>
					<div class="label">Canciones Publicas</div>
				</div>
								<!-- Total de usuarios Inactivos -->
				<div class="statistic">
